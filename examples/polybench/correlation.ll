...
entry:
  ...
  store [1200 x [1200 x double]]* %1, [1200 x [1200 x double]]** %corr, align 8
  ...
  %3 = bitcast i8* %call3 to [1200 x double]*
  store [1200 x double]* %3, [1200 x double]** %stddev, align 8
  %4 = load i32, i32* %m, align 4
  %5 = load i32, i32* %n, align 4
  %6 = load [1400 x [1200 x double]]*, [1400 x [1200 x double]]** %data, align 8
  %arraydecay = getelementptr inbounds [1400 x [1200 x double]], [1400 x [1200 x double]]* %6, i32 0, i32 0
  call void @init_array(i32 %4, i32 %5, double* %float_n, [1200 x double]* %arraydecay)
  %7 = load i32, i32* %m, align 4
  %8 = load i32, i32* %n, align 4
  %9 = load double, double* %float_n, align 8
  %10 = load [1400 x [1200 x double]]*, [1400 x [1200 x double]]** %data, align 8
  %arraydecay4 = getelementptr inbounds [1400 x [1200 x double]], [1400 x [1200 x double]]* %10, i32 0, i32 0
  %11 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %corr, align 8
  %arraydecay5 = getelementptr inbounds [1200 x [1200 x double]], [1200 x [1200 x double]]* %11, i32 0, i32 0
  %12 = load [1200 x double]*, [1200 x double]** %mean, align 8
  %arraydecay6 = getelementptr inbounds [1200 x double], [1200 x double]* %12, i32 0, i32 0
  %13 = load [1200 x double]*, [1200 x double]** %stddev, align 8
  %arraydecay7 = getelementptr inbounds [1200 x double], [1200 x double]* %13, i32 0, i32 0
  call void @kernel_correlation(i32 %7, i32 %8, double %9, [1200 x double]* %arraydecay4, [1200 x double]* %arraydecay5, double* %arraydecay6, double* %arraydecay7)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call8 = call i32 @strcmp(i8* %16, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0))
  %tobool = icmp ne i32 %call8, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %17 = load i32, i32* %m, align 4
  %18 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %corr, align 8
  %arraydecay9 = getelementptr inbounds [1200 x [1200 x double]], [1200 x [1200 x double]]* %18, i32 0, i32 0
  call void @print_array(i32 %17, [1200 x double]* %arraydecay9)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %19 = load [1400 x [1200 x double]]*, [1400 x [1200 x double]]** %data, align 8
  %20 = bitcast [1400 x [1200 x double]]* %19 to i8*
  call void @free(i8* %20)
  %21 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %corr, align 8
  %22 = bitcast [1200 x [1200 x double]]* %21 to i8*
  call void @free(i8* %22)
  %23 = load [1200 x double]*, [1200 x double]** %mean, align 8
  %24 = bitcast [1200 x double]* %23 to i8*
  call void @free(i8* %24)
  %25 = load [1200 x double]*, [1200 x double]** %stddev, align 8
  %26 = bitcast [1200 x double]* %25 to i8*
...
entry:
  ...
  store double %float_n, double* %float_n.addr, align 8
  store [1200 x double]* %data, [1200 x double]** %data.addr, align 8
  store [1200 x double]* %corr, [1200 x double]** %corr.addr, align 8
...
for.body22:                                       ; preds = %for.cond20
  %25 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  ...
  %32 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  %33 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %33 to i64
  %arrayidx30 = getelementptr inbounds [1200 x double], [1200 x double]* %32, i64 %idxprom29
...
for.body64:                                       ; preds = %for.cond62
  ...
  %70 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  %71 = load i32, i32* %i, align 4
  %idxprom67 = sext i32 %71 to i64
  %arrayidx68 = getelementptr inbounds [1200 x double], [1200 x double]* %70, i64 %idxprom67
  ...
  %mul74 = fmul double %75, %78
  %79 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  %80 = load i32, i32* %i, align 4
  %idxprom75 = sext i32 %80 to i64
  %arrayidx76 = getelementptr inbounds [1200 x double], [1200 x double]* %79, i64 %idxprom75
...
for.body89:                                       ; preds = %for.cond86
  %87 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %88 = load i32, i32* %i, align 4
  %idxprom90 = sext i32 %88 to i64
  %arrayidx91 = getelementptr inbounds [1200 x double], [1200 x double]* %87, i64 %idxprom90
...
for.body97:                                       ; preds = %for.cond95
  %93 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %94 = load i32, i32* %i, align 4
  %idxprom98 = sext i32 %94 to i64
  %arrayidx99 = getelementptr inbounds [1200 x double], [1200 x double]* %93, i64 %idxprom98
...
for.body104:                                      ; preds = %for.cond102
  %98 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  %99 = load i32, i32* %k, align 4
  %idxprom105 = sext i32 %99 to i64
  %arrayidx106 = getelementptr inbounds [1200 x double], [1200 x double]* %98, i64 %idxprom105
  ...
  %102 = load [1200 x double]*, [1200 x double]** %data.addr, align 8
  %103 = load i32, i32* %k, align 4
  %idxprom109 = sext i32 %103 to i64
  %arrayidx110 = getelementptr inbounds [1200 x double], [1200 x double]* %102, i64 %idxprom109
  ...
  %mul113 = fmul double %101, %105
  %106 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %107 = load i32, i32* %i, align 4
  %idxprom114 = sext i32 %107 to i64
  %arrayidx115 = getelementptr inbounds [1200 x double], [1200 x double]* %106, i64 %idxprom114
...
for.end121:                                       ; preds = %for.cond102
  %111 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %112 = load i32, i32* %i, align 4
  %idxprom122 = sext i32 %112 to i64
  %arrayidx123 = getelementptr inbounds [1200 x double], [1200 x double]* %111, i64 %idxprom122
  ...
  %115 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %116 = load i32, i32* %j, align 4
  %idxprom126 = sext i32 %116 to i64
  %arrayidx127 = getelementptr inbounds [1200 x double], [1200 x double]* %115, i64 %idxprom126
...
for.end135:                                       ; preds = %for.cond86
  %120 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
  %121 = load i32, i32* %m.addr, align 4
  %sub136 = sub nsw i32 %121, 1
  %idxprom137 = sext i32 %sub136 to i64
  %arrayidx138 = getelementptr inbounds [1200 x double], [1200 x double]* %120, i64 %idxprom137
...
entry:
  ...
  %call1 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %11 = load [1200 x double]*, [1200 x double]** %corr.addr, align 8
...
for.end12:                                        ; preds = %for.cond
  ...
  %call13 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
